...
export const estSpécificationHoroDatage = (val: unknown): val is spécificationHoroDatage => {
    return !!val && (typeof (val as spécificationHoroDatage).système === 'string' && typeof (val as spécificationHoroDatage).val === 'string')
}
