...
export const prisesCréationCompte = async ({ 
    ...
    if (déjàGénérés({ images: ['nouveauCompte.png'], langue, obtCheminImage })) return;
    ...
    await page.screenshot({ path: obtCheminImage({ nomImage: 'nouveauCompte.png', langue }), ...optsPrises });
}